...
- Both "name" and "resume_highlights" must be strings (not arrays or objects)
- If name is not found, use "Candidate" as default
- If highlights are not found, extract any relevant information from the resume

Response Format (MUST be valid JSON):
{{
    "name": "<Full name of the candidate as it appears on the resume, or 'Candidate' if not found>",
    "resume_highlights": "<Paragraphs of highlights from the resume, or key information if highlights not available>"
}}
"""
